<template>
  <div class="section-content">
    ...
    <div class="update-card">
      ...
      <div
        v-else-if="updateStore.updateInfo && !updateStore.updateInfo.hasUpdate"
        class="update-message success"
      >
        {{ t('upToDate') }}
      </div>
      ...
      <div v-if="updateStore.updateInfo?.hasUpdate" class="update-available">
        ...
        <p v-else-if="updateStore.downloadState === 'installing'" class="update-message">
          {{ t('installingUpdate') }}
        </p>
        <p v-else-if="updateStore.downloadState === 'error'" class="update-message error">
          {{ updateStore.downloadError }}
        </p>

        <div class="action-row">
          <button
            v-if="updateStore.downloadState === 'idle'"
          ...
          <button
            v-if="updateStore.downloadState === 'error'"
            class="action-btn primary"
            @click="handleRetry"
          >
            {{ t('retry') }}
    ...
    <div v-if="showConfirm" class="confirm-overlay" @click.self="showConfirm = false">
      <div class="confirm-dialog">
        ...
        <div class="action-row">
          <button class="action-btn secondary" @click="showConfirm = false">
            {{ t('cancel') }}
          </button>
          <button class="action-btn primary" @click="confirmUpdate">
            {{ t('downloadAndInstall') }}
          </button>
        </div>
      </div>
...
function openReleases() {
  void open('https://github.com/shawnwu2022/cc-desk/releases')
}
